...
//    return a + b;
// }
// alert(`Результат сложения ${num1} + ${num2} = ${sum(num1, num2)}`);
...
//  использовать confirm.- При нажатии на кнопку “ОК” вывести в 
// диалоговом окне текст с сообщением “Тогда мы идем к вам!”.-
