...
$exper = [
    [
        ...
        'dateStart' => 'jan 2015',
        'dateEnd' => 'current',
        'text' => ' Простой текст описывает опыт работы и прочее',
    ],
    [
        'work' => 'Веб девэлопер',
        'dateStart' => 'mar 2012',
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Навыки</b></p><?php for ($i = 0; $i < count($skills); $i++):?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2><?php for ($i = 0; $i < count($exper); $i++):?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $exper[$i]['work'] ?></b></h5>
            <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>
            	<?php echo $exper[$i]['dateStart'] ?>- 
                <?php if ($i == 0):?>
                	<span class="w3-tag w3-teal w3-round">
                		<?php echo $exper[$i]['dateEnd'] ?>
                    </span>
                    <?php else: ?>
                    	<?php echo $exper[$i]['dateEnd'] ?>
                 <?php endif;?>
            </h6>
            <p><?php echo $exper[$i]['text'] ?></p>
            <hr>
          </div>
          <?php endfor; ?>
